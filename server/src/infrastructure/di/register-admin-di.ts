...
import { CreateJobCategoryUseCase } from 'src/application/use-cases/admin/attributes/job-categories/create-job-category.use-case';
import { GetAllJobCategoriesUseCase } from 'src/application/use-cases/admin/attributes/job-categories/get-all-job-categories.use-case';
import { GetJobCategoryByIdUseCase } from 'src/application/use-cases/admin/attributes/job-categories/get-job-category-by-id.use-case';
import { UpdateJobCategoryUseCase } from 'src/application/use-cases/admin/attributes/job-categories/update-job-category.use-case';
import { DeleteJobCategoryUseCase } from 'src/application/use-cases/admin/attributes/job-categories/delete-job-category.use-case';
...
export function registerAdminDi(container: Container): void {
  ...
  container.bind<IUseCase<CreateJobCategoryRequestDto, JobCategoryResponseDto>>(TYPES.CreateJobCategoryUseCase).to(CreateJobCategoryUseCase);
  container.bind<IUseCase<GetAllJobCategoriesQueryDto, PaginatedJobCategoriesResultDto>>(TYPES.GetAllJobCategoriesUseCase).to(GetAllJobCategoriesUseCase);
  container.bind<IUseCase<string, JobCategoryResponseDto>>(TYPES.GetJobCategoryByIdUseCase).to(GetJobCategoryByIdUseCase);
  container.bind<IUseCase<{ id: string; dto: UpdateJobCategoryRequestDto }, JobCategoryResponseDto>>(TYPES.UpdateJobCategoryUseCase).to(UpdateJobCategoryUseCase);
  container.bind<IUseCase<string, boolean>>(TYPES.DeleteJobCategoryUseCase).to(DeleteJobCategoryUseCase);
