...
import { ICreateJobCategoryUseCase, IGetAllJobCategoriesUseCase, IGetJobCategoryByIdUseCase, IUpdateJobCategoryUseCase, IDeleteJobCategoryUseCase } from '../../../domain/interfaces/use-cases/IJobCategoryUseCases';
