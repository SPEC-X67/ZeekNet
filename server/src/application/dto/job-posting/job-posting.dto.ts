...
export const CreateJobPostingRequestDto = z.object({
  ...
  qualifications: z.array(
    z.string().min(5, 'Each qualification must be at least 5 characters'),
  ...
  category_ids: z.array(z.string().min(1, 'Category ID is required'))
...
export const CreateJobPostingDto = z.object({
  ...
  qualifications: z.array(
    z.string().min(10, 'Each qualification must be at least 10 characters'),
  ).min(1, 'At least one qualification is required'),
  nice_to_haves: z.array(z.string()).default([]),
  benefits: z.array(z.string()).default([]),
  salary: SalarySchema,
...
export type CreateJobPostingDto = z.infer<typeof CreateJobPostingDto>;
