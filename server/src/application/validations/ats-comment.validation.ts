import { z } from 'zod';
import { ATSStage, InReviewSubStage, ShortlistedSubStage, InterviewSubStage, TechnicalTaskSubStage, CompensationSubStage, OfferSubStage } from 'src/domain/enums/ats-stage.enum';
