...
export const CreateSkillSchema = CreateSkillRequestSchema;
...
export const GetAllSkillsSchema = GetAllSkillsQuerySchema;
export const UpdateSkillRequestSchema = z.object({
  name: z.string().min(1, 'Skill name is required').max(100, 'Skill name must be less than 100 characters').trim(),
});
export const UpdateSkillSchema = UpdateSkillRequestSchema;
