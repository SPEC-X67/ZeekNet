...
export const AddEducationRequestSchema = z.object({
...
export const AddEducationSchema = AddEducationRequestSchema;
...
export const UpdateEducationSchema = UpdateEducationRequestSchema;
