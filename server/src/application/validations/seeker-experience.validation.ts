...
export const EmploymentTypeSchema = z.enum(['full-time', 'part-time', 'contract', 'internship', 'remote', 'freelance']);
export const AddExperienceRequestSchema = z.object({
...
export const AddExperienceSchema = AddExperienceRequestSchema;
...
export const UpdateExperienceSchema = UpdateExperienceRequestSchema;
